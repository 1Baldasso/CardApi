...
public class UpdatePreProcessing : IPreProcessor<UpdateCardDto>
{
    public Task PreProcessAsync(UpdateCardDto req, HttpContext ctx, List<ValidationFailure> failures, CancellationToken ct)
    {
        if(req is null)
        {
